...
public class ImageCommon {
	static final String PATH = "/flash/.thumbnails/";
	public static HashMap<String, LinkedList<String>> getAlbumsInfo(Cursor cursor) {
	...
	public static LinkedList<ImageInfo> getImageInOneAlbum(Resources res, String[] pathArrary) {
